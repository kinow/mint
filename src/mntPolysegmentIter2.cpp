...
PolysegmentIter::PolysegmentIter(const UgridReader& ur, const FaceLocator& locator, 
...
PolysegmentIter::__collectIntersectionPoints(const double pBeg[], 
    ...
    std::set<vtkIdType> faceIds = this->locator.getFacesAlongLine((double*) &pBeg[0], 
                                                                  (double*) &pEnd[0]);
