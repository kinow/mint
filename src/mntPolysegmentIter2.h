...
#include <mntFaceLocator.h>
#include <map>
#include <algorithm>

#ifndef MNT_POLYSEGMENT_ITER_2
#define MNT_POLYSEGMENT_ITER_2
...
public:
     ...
     * @param p1 end point
     */
    PolysegmentIter(const UgridReader& ur, const FaceLocator& locator, 
